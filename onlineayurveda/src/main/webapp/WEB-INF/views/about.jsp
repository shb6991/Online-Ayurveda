...
<div class="privacy about">
	<h3>About Us</h3>
	<p class="animi">At vero eos et accusamus et iusto odio dignissimos
		...
		<div class="container">
			...
			<div class="agileits_team_grids">
				<div class="col-md-3 agileits_team_grid">
					<img src="${images }/martin.jpg" alt=" " class="img-responsive" />
					<h4>Martin Paul</h4>
					<p>Manager</p>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="${images }/mic.jpg" alt=" " class="img-responsive" />
					<h4>Michael Rick</h4>
					<p>Supervisor</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="${images }/thomas.jpg" alt=" " class="img-responsive" />
					<h4>Thomas Carl</h4>
					<p>Supervisor</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="${images }/laura.jpg" alt=" " class="img-responsive" />
					<h4>Laura Lee</h4>
					<p>CEO</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
