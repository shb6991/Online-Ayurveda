...
public class FileUploadUtility {
	...
	private static final String ABS_PATH = "D:\\TIIN Project\\Online-Ayurveda\\onlineayurveda\\src\\main\\webapp\\assets\\images";
	...
	public static void uploadFile(HttpServletRequest request, MultipartFile file, String code) {
		...
		//if not create the directory for me
		
		if(!new File(ABS_PATH).exists()){
			//create the firectories
